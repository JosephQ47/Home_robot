...
#include "ax_uart1.h"    //调试串口
#include "ax_uart2.h"    //ROS USB通信串口
#include "ax_uart3.h"    //蓝牙串口
#include "ax_uart4.h"    //ROS TTL通信串口
...
//电池
#define  VBAT_40P    1119     //电池40%电压
#define  VBAT_20P    1086     //电池20%电压
#define  VBAT_10P    1050     //电池10%电压

//机器人软件版本
#define  ROBOT_FW_VER   "V3.61"
...
#define  MEC_WHEEL_DIAMETER	      0.097		  //普通轮子直径0.097，  金属麦轮改为0.077
